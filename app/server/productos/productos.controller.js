...
const query_producto_dto_1 = require("./dto/query-producto.dto");
let ProductosController = class ProductosController {
    ...
    findAll(query) {
        return this.productosService.query(query);
    }
    findOne(id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [query_producto_dto_1.QueryProductoDto]),
    __metadata("design:returntype", void 0)
