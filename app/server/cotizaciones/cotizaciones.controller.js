...
const query_cotizacion_dto_1 = require("./dto/query-cotizacion.dto");
...
let CotizacionesController = class CotizacionesController {
    ...
    findAll(query) {
        return this.cotizacionesService.query(query);
    }
    findOne(id) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [query_cotizacion_dto_1.QueryCotizacionDto]),
    __metadata("design:returntype", void 0)
